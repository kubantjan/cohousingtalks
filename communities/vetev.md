...
members:
  - name: Peťa
    img: /assets/images/vetev/vetev-peta-1024x512.png
    bio: "Přes 4 roky jsem žila v komunitě Kmen. Ráda zahradničím, jezdím na kole (z kopce), hraju frisbee, chodím na šifrovačky, ztrácím se (nejen) v lese. Mám ráda hraní her (zážitkových, občas i deskových), a ráda taky hry a aktivity organizuju. Podílím se na vedení v tábornickém oddíle. Pracuju jako grafička."
  - name: Isabella
  ...
  - name: Terka
    img: /assets/images/vetev/Terka_na-web2-1024x512.png
    bio: "Instruktorka jógy s velkou vášní pro tanec (zejména brazilský zouk a forró, občas také kontaktní improvizace). Pocházím z Polska a Česko jsem si zamilovala během studia, což mě nakonec přivedlo k životu tady. Volný čas trávím v přírodě, zejména v létě, kdy si ráda zaplavu v řece, a na různých kulturních a komunitních akcích v Praze. Ráda vařím vegetariánská jídla a pravidelně dobíjím energii v sauně."
  - name: Honza
    img: /assets/images/vetev/Honza_na-web-1024x512.png
    bio: "Milovník dobré četby, sýrů všech druhů a přírody. V Praze hodně často vyhledávám divadelní představení a zajímavé eventy. A pokud se jedná o kvalitní filmografii, počítejte určitě se mnou."
  - name: Zázvor
...
- Aktivně budovat blízké vztahy
- Být místem setkávání – pořádat akce (promítání, kytarohraní, zahradní slavnost, bytový koncert…) pro naše kamarády (jednou třeba i pro veřejnost), propojovat lidi.
- Hledáme někoho, kdo bude ochoten vložit trochu své energie do toho, aby se nám tu dobře žilo, podílet se na chodu.

### Fungování v bodech

**Pravidelné aktivity**

- **Kruh** (cca 1x za 3 týdny) – pro sdílení, otevírání témat a předcházení konfliktům, pro budování dobrých vztahů
- **Provozní lístečky** – offline systém na dělbu úkolů, co je potřeba udělat/opravit
- **Víkendovka** – (cca 2x do roka) spolu vyjedem někam ven, tvoříme si sami program (relaxační/vzdělávací…)
- **1on1** – (cca 1x za půl roku) povídání jeden na jednoho, jak se nám spolu bydlí. Probíhá většinou formou strukturovaného večera.

Takto je to zhruba nastavené teď, ale třeba se časem domluvíme na jiném formátu či frekvenci.
...
Neradi se do něčeho nutíme, chceme dělat věci, protože nám dávají smysl. Služby (na úklid, vynášení odpadků, vaření…) proto nemáme, k úkolům, co jsou potřeba udělat/opravit se hlásíme dobrovolně. Spoléháme na sebe navzájem, že každý přiloží ruku k dílu a bude dělat to, v čem je dobrý a co ho baví. Cca jednou měsíčně k nám chodí uklízečka (o náklady se dělíme).

**Aplikace (bez kterých se neobejdeme:))**
...
1. **Bydlet s přáteli, sdílet.** Ano, komunita vyžaduje nějakou energii. Někdy to možná bude náročný. Ale stojí to za to: bydlet s lidmi, kteří se stanou tvými přáteli, v domě, který si společně upravíme tak, aby se nám tam dobře žilo.
